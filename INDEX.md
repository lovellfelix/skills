...
| **jarvis-workflows** | `portable/jarvis-workflows/` | Use when operating or coordinating the Jarvis fleet across the Mac orchestrator, remote Jarvis hosts, managed agents, or the jarvis-claude worker and you need the correct transport, queue, or scheduler path. |
