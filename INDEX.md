...
| **python-code-style** | `portable/python-code-style/` | Use when writing new code, reviewing style, configuring linters, writing docstrings, or establishing project standards. Covers Python code style, linting, formatting, naming conventions, and documentation. |
| **python-standards** | `portable/python-standards/` | Use when writing, reviewing, or refactoring Python code to apply engineering standards for type safety, error handling, structure, and observability. Triggers on .py files or Python-related tasks. |
...
| **rfc-blueprint** | `portable/rfc-blueprint/` | Use when writing an RFC, technical design doc, or architecture proposal and need a strict, opinionated blueprint format with Mermaid diagrams. |
