...
Harness-agnostic core instructions used across all coding tools (Claude Code, OpenCode, Copilot, Cursor, Forge).
...
This user works across multiple coding harnesses: Claude Code, OpenCode, Copilot, Cursor, and Forge.
